...
### ✨ 1. 在线免安装体验 (推荐)
直接点击访问已托管至 Cloudflare Pages 的在线演示版本，授予摄像头权限即可开始体验：
👉 **[空间 3D 产品配置中心 (Pages.dev)](https://spatial-3d-configurator.pages.dev)**
...
npm run dev
```
启动后在浏览器中打开控制台输出的本地开发地址（通常为 [http://localhost:5173/](http://localhost:5173/)），授予摄像头权限，将手掌伸入摄像头视野内即可开始隔空手势拆解与配置！
